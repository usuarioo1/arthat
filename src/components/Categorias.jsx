    ...
    return (
        <div className="flex flex-wrap justify-around mt-24">
            ...
            <div className="w-64 mx-2 mb-4 bg-white shadow-lg rounded-lg overflow-hidden">
                <img className="w-full h-40 object-cover" src="https://res.cloudinary.com/dpbpyzl96/image/upload/v1714528155/arthat/e1p6oyfnxzwnvohkfvkc.jpg" alt="Imagen Niños ELA" />
            ...
            <div className="w-64 mx-2 mb-4 bg-white shadow-lg rounded-lg overflow-hidden">
                <img className="w-full h-40 object-cover" src="https://res.cloudinary.com/dpbpyzl96/image/upload/v1714528155/arthat/jynwtqjsqsnoqv8bi1ms.jpg" alt="Imagen Madres y Niños" />
                <div className="px-4 py-2">
            ...
            <Link href='/amuletos'>
            <div className="w-64 mx-2 mb-4 bg-white shadow-lg rounded-lg overflow-hidden">
                <img className="w-full h-40 object-cover" src="https://res.cloudinary.com/dpbpyzl96/image/upload/v1714528154/arthat/hux0ubv47am4kdd0hqrs.jpg" alt="Imagen Amuletos" />
                <div className="px-4 py-2">
            ...
            <Link href='/runas'>
            <div className="w-64 mx-2 mb-4 bg-white shadow-lg rounded-lg overflow-hidden">
                <img className="w-full h-40 object-cover" src="https://res.cloudinary.com/dpbpyzl96/image/upload/v1714528155/arthat/ajubizwvacj9elahpohq.jpg" alt="Imagen Runas" />
                <div className="px-4 py-2">
            ...
            <div className="w-64 mx-2 mb-4 bg-white shadow-lg rounded-lg overflow-hidden">
                <img className="w-full h-40 object-cover" src="https://res.cloudinary.com/dpbpyzl96/image/upload/v1714528155/arthat/vaztbzxbsrjm5vbilr72.jpg" alt="Imagen Profesiones" />
                <div className="px-4 py-2">
